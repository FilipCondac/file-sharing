...
const RenderFile: React.FunctionComponent<{ file: IFile }> = ({
  ...
  return (
    <div className="flex flex-col items-center p-20 mb-5 w-96 rounded-2xl bg-gradient-to-r from-slate-800 to-slate-900 justify-centre hover:wiggle text-primarycolor-lightest">
